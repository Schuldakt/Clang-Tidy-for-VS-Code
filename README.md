...
Found an issue or want to contribute? Please review the [CONTRIBUTING.md](CONTRIBUTING.md) and report any bugs or feature requests on our [GitHub repository](https://github.com/Schuldakt/VSCode-Clang-Tidy).
